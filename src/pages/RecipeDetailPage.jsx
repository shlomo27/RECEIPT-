...
export default function RecipeDetailPage() {
  ...
  const [savedListMsg, setSavedListMsg] = useState(null);
  ...
  const handleSaveToShoppingList = async () => {
    ...
    try {
      await api.saveShoppingList(recipe.title, ingredients.ingredients);
      setSavedListMsg('הרשימה נשמרה בהצלחה!');
      setTimeout(() => setSavedListMsg(null), 3000);
    } catch (err) {
  ...
  return (
    <div className="pt-6 max-w-4xl mx-auto">
      ...
      <div className="card p-6 mb-6">
        ...
        {savedListMsg && (
          <div className="mt-3 text-sm text-green-600 bg-green-50 px-4 py-2 rounded-lg animate-fade-in">
            {savedListMsg}
          </div>
        )}
      </div>
